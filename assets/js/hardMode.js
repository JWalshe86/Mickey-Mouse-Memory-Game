...
function checkForMatch() {
  ...
  then the cards will be unflipped back to their original state.  /*If the cards don't match then they need to be unflipped. To do this the 
	...
	const Daudio = document.getElementsByClassName('dd')[0];
	const Dyaudio = document.getElementsByClassName('dyd')[0];
	const Paudio = document.getElementsByClassName('p')[0];
	const Gaudio = document.getElementsByClassName('g')[0];
	const Miaudio = document.getElementsByClassName('mi')[0];

	function UniqueSoundPlayUponCardMatch(first) {

		if (isMatch && first === first) {
			console.log('first here', first)
			document.getElementsByClassName(`${first}`)[0].play();
			return;
		}
		...
		// if (isMatch && first === 'daisy-duck') {
		// 	Dyaudio.play();
		// }
		// if (isMatch && first === 'pete') {
		// 	Paudio.play();
		// }
		// if (isMatch && first === 'pluto') {
		// 	Gaudio.play();

		// }
		// if (isMatch && first === 'minnie-mouse') {
		// 	Miaudio.play();
		// }
	...
	let myPlayMickey = function () {
		...
		// var Maudio = document.getElementsByClassName('mm')[0];
	...
	let myPlayDonald = function () {
		...
		// let Daudio = document.getElementsByClassName('dd')[0];
	...
	let myPlayGoofy = function () {
		// let audio = document.getElementsByClassName('goofy')[0];
		// Plaudio.play();
		setTimeout(() => {
			lockBoard = false;
		}, 1000);
